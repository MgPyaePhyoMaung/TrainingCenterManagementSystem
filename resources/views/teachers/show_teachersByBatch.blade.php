                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">View Teacher</strong><a href="/student_batch" style="float:right;color:red;text-decoration: underline;text-decoration:none;"><i class="fa fa-arrow-left"></i>&nbsp;<small>Back</small></a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    @foreach($teachers as $teacher)
                                     @if($teacher->batch_id==$batches->id && $teacher->course_id==$batches->course_id)
