                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">View Expense</strong><a href="/expenses/create" style="float:right;color:red;text-decoration: underline;"><i class="fa fa-newspaper-o"></i>&nbsp;<small>New Expense</small></a>
                            </div>
                            <div class="card-body">
...
<div id="deleteModal" class="modal fade"tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <script type="text/javascript">
        ...
        $('.delete').on('click',function(){
            ...
            console.log(data);
            $('#deleteForm').attr('action','/expenses/'+data[0]);
