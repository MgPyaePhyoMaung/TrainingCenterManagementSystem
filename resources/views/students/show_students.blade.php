                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">View Student</strong><a href="/students/create" style="float:right;color:red;text-decoration: underline;"><i class="fa fa-users"></i>&nbsp;<small>New Student</small></a>
                            </div>
                            <div class="card-body">
